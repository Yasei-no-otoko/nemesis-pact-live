...
test('classic mechanics are byte-identical after undoing the three explicit virtual-hook extractions',()=>{
  ...
  text=text.replace('    protectBullet(b){return this.mods.sanctuary&&segmentHit(b.px,b.py,b.x,b.y,this.width/2,this.height/2,76);}\n','').replace('if(this.protectBullet(b)){b.life=0;continue;}','if(this.mods.sanctuary&&segmentHit(b.px,b.py,b.x,b.y,W/2,H/2,76)){b.life=0;continue;}');
