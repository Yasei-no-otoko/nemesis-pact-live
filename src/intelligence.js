...
function mock(request){const r=cleanRequest(request),p=r.prompt.toLowerCase();let intent=r.allowed[0];
 const rules=[['mercy',/slow|speed|time|easier|\u9045|\u3086\u3063\u304f\u308a|\u6613\u3057/],['mirror',/return|reflect|parry|mirror|\u53cd\u5c04|\u30d1\u30ea\u30a3|\u8df3\u306d\u8fd4|\u6483\u3061\u8fd4|\u5df1\u306e\u5f3e|\u81ea\u5206\u306e\u5f3e/],['glass',/damage|armor|glass|fragile|\u88c5\u7532|\u706b\u529b|\u30c0\u30e1\u30fc\u30b8|\u8106/],['silence',/stop|silence|cease|quiet|\u505c\u6b62|\u6b62\u3081|\u505c\u6226|\u6c88\u9ed9/],['duel',/alone|adds|minion|duel|witness|\u4e00\u5bfe\u4e00|\u5897\u63f4\u306a\u3057|\u5897\u63f4\u306f\u306a\u3044|\u53d6\u308a\u5dfb\u304d\u306a\u3057|\u76ee\u6483|\u4e8c\u4eba\u3060\u3051/],['sanctuary',/safe|center|shelter|ground|\u5b89\u5168|\u4e2d\u592e|\u7d50\u754c|\u907f\u96e3/],['velocity',/dash|fast|mobile|velocity|\u30c0\u30c3\u30b7\u30e5|\u901f\u304f|\u9ad8\u901f|\u6a5f\u52d5/]];
 ...
 if(/steady|balanced|gentle|safe|\u30d0\u30e9\u30f3\u30b9|\u5747\u8861|\u6a19\u6e96|\u7a4f\u3084\u304b/.test(p))directorId='balanced';if(/cross|lattice|turret|\u5341\u5b57|\u4ea4\u5dee|\u683c\u5b50|\u7832\u5854/.test(p))directorId='crossfire';if(/hunt|pursuit|chase|\u8ffd\u5c3e|\u8ffd\u8de1|\u8ffd\u6483/.test(p))directorId='pursuit';
