...
Return exactly the JSON schema. version=1; title <=48 characters; line <=240; rationale <=360. Use a short title and one-sentence rationale. The dialogue may contain partial voice transcripts and later corrections. The latest explicit correction overrides earlier terms; preserve the other unchanged requested clauses.
