# Submission form guide — checked2026-09-15
...
|---|---|
| Representative email | Private local submission kit |
| Team or Solo | Solo |
| Team name | Private local submission kit |
| All member names | Private local submission kit |
| Track | Track1:AI-Native Game Prototype |
| Title | NEMESIS PACT — Living Covenant |
...
The custom renderer uses WebGL2 and WebGPU; combat logic is two-dimensional with procedural3D presentation. The draft credits the existing baseline and emphasizes real negotiated mechanics without claiming the whole engine was newly created or claiming universal novelty. Concept boards are development artifacts, not fabricated gameplay screenshots.

License checks: installed @vercel/functions3.9.7 LICENSE is Apache2.0. [Narkowicz's primary curve source](https://knarkowicz.wordpress.com/2016/01/06/aces-filmic-tone-mapping-curve/) explicitly offers CC0 or MIT; the project records CC0. Other versioned tool notices and source links remain in THIRD_PARTY_NOTICES.md and SOURCES-AND-LICENSES.md. Project-specific code remains without a newly assigned license.
