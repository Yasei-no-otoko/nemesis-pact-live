...
| Current unit suite | 197 / 197; zero failed; 5624 ms | Node 22.23.2, 2026-09-14; injected upstream/media fixtures are not live proof |
| Current syntax/build | 33 files; standalone HTML 359615 bytes | Generated from source; hosted microphone policy checked independently |
...
| Voice admission | Missing/invalid Origin, cookie, CSRF, expired identity and extra fields rejected; quota denial/store failure stop before upstream | `voice-admission/`; two matrix tests included in the 197; fixtures, not live API |
