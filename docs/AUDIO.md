> Historical v0.4.1 subsystem document retained as baseline reference. For v0.5.0 use README.md, LIVING-COVENANT.md and VALIDATION-0.5.0.md. New covenant configuration is in .env.example.
