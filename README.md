...
[Play on production HTTPS](https://nemesis-pact-live.vercel.app) · [Watch the 59-second 1080p60 demo](https://www.circle-hydrangea.net/nemesis-pact-live/) · [Current validation](docs/VALIDATION-CURRENT.md) · [Japanese guide](README-JA.md)

**Latest English film, September 15:** one complete six-sector production campaign, edited in native DaVinci Resolve into 59 seconds with English captions and original synchronized audio. The public viewer now includes eight refreshed gameplay/interface screenshots and the final Luna debrief. All 3,540 encoded frames, audio alignment, public asset hashes and playback through the ending are verified. Demo autoplay and synthetic player speech are disclosed. [Media and verification](docs/MEDIA-REFRESH-20260915.md).
